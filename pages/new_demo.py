...
col1, col2, col3, col4,col5 = section1.tabs(["Demographics","Roles","Company","Product","Generate"])
...
if section2.button('Generate Persona Image'):
    ...
    imagePrompt = f"a single portrait drawing of the following persona: {personas[selected_persona]}"
