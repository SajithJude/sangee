...
if user_input == 'Upload File':
    ...
    try:    
        ...
        section1.info("Upload a Persona File to get Started")
        # else:
        #     section1.write("")
